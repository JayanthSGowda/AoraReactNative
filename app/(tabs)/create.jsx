    ...
    <SafeAreaView className=" bg-primary h-full">
      <ScrollView className="px-4 my-6">
        ...
        <FormField 
          title="Video Title"
          value={form.title}
          placeholder="Give your video a juicy title..."
        ...
        <View className="mt-7 space-y-2">
          ...
          <TouchableOpacity onPress={() => openPicker('video')}>
            {form.video ? (
              <Video source={{ uri: form.video.uri}} className="w-full h-64 rounded-xl" resizeMode={ResizeMode.COVER}/>
            ) : (
        ...
        <View className="mt-7 space-y-2">
          <Text className="text-base text-gray-100 font-pmedium">Tumbnail Image</Text>
        ...
        <FormField 
          title="Tags"
          value={form.prompt}
          placeholder="Whats in the video... add as many as you can"
